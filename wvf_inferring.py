...
fig.savefig("plots/task_2_reward.png", bbox_inches='tight')
plt.show()
fig=env.render(WVF=WVF)
fig.savefig("plots/task_2_wvf.png", bbox_inches='tight')
plt.show()
fig=env.render( P=P, V = VF)
fig.savefig("plots/task_2_vf.png", bbox_inches='tight')
plt.show()
...
fig = env.render(R=env.get_rewards())
fig.savefig("plots/task_3_reward.png", bbox_inches='tight')
plt.show()
fig=env.render(WVF=WVF)
fig.savefig("plots/task_3_wvf.png", bbox_inches='tight')
plt.show()
fig=env.render( P=P, V = VF)
fig.savefig("plots/task_3_vf.png", bbox_inches='tight')
plt.show()